...
sub send_ssl_get{
    my ($class_or_self, $host, $port, $req_uri, $ref_headermap, $brief_flag, $debug_flag) = @_;
    my $response = "";
...
sub send_post{
    my ($class_or_self, $host, $port, $req_uri, $ref_parammap, $payload, $ref_headermap, $brief_flag, $debug_flag) = @_;
    my $response = "";
